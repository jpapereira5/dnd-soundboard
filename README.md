...
- **Quatro grupos por cena**: Ambiente (várias faixas) toca sempre com a cena; Música e Batalha (uma faixa ou playlist cada) alternam, tocar uma faz fade out à outra; Efeitos são sons curtos disparados por botão ou tecla, sem loop.
